...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Seabiscuit's fuel = " + seabiscuit.getFuelLevel());
        ...
        System.out.println("Secretariat fuel = " + secretariat.getFuelLevel());
        ...
        printVehicles(myList, v -> v.getFuelLevel() < 1);
        System.out.println();
