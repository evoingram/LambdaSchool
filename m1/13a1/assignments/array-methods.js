...
let fullNames = [];
runners.forEach(getRunnerFullName);
function getRunnerFullName(runner) {
...
runners.map(getRunnerFirstNameCaps);
function getRunnerFirstNameCaps (runner) {
...
let ticketPriceTotal = runners.reduce(
  function (ticketPriceTotal, runner) {
