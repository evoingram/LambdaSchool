      ...
      <Form>
        ...
        {touched.description && errors.description && <p>{errors.description}</p>}
          ...
          <FormField>
            ...
            <SCField>
          <Field type="text" name="category" placeholder={ticket.category} value={values.category} style={fieldLength} />
            </SCField>          
          </FormField>
          <FormField>
            <Label>Status:</Label>
            <SCField>
          <Field type="text" name="statusT" placeholder={ticket.statusT} value={values.statusT} style={fieldLength} />
            </SCField>          
          </FormField>
          <FormField>
            <Label>What You Tried:</Label>
            <SCField>
          <Field type="text" name="description" placeholder={ticket.description} value={values.description} style={fieldLength} />
            </SCField>          
          </FormField>
            </Div>
        <ButtonRow>
